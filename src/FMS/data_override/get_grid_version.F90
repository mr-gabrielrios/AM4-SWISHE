...
subroutine get_grid_version_2(fileobj, mod_name, domain, isc, iec, jsc, jec, lon, lat, min_lon, max_lon)
  ...
  if(variable_exists(fileobj, trim(mod_name)//'_mosaic_file' )) then
     ...
     write(*, *) '[data_override_mod] solo_mosaic_file: ', solo_mosaic_file
     ...
     write(*, *) '[data_override_mod] open_solo_mosaic: ', open_solo_mosaic
  else
  ...
  write(*, *) '[data_override_mod] mod_name: ', mod_name
  write(*, *) '[data_override_mod] grid file name: ', grid_file
