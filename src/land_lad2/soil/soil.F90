...
! soil model module
! ============================================================================
!wy2025-01-22: add fix_neg_subsurface_wl_warning to namelist to control too much warming message
module soil_mod
...
logical :: fix_neg_subsurface_wl_warning       = .true. !wy2025-01-22
...
namelist /soil_nml/ lm2, use_E_min, use_E_max,           &
                    ...
                    allow_neg_rnu, allow_neg_wl, fix_neg_subsurface_wl, fix_neg_subsurface_wl_warning, prohibit_negative_water_div, &
                    zeta_bar_override, &
                    cold_depth, Wl_min, &
                    bwood_macinf, &
  ...
  if (fix_neg_subsurface_wl) then
    do l=2, num_l
      if ((soil%wl(l)+dW_l(l))/(dens_h2o*dz(l)*soil%pars%vwc_sat) < thetathresh) then
        if (fix_neg_subsurface_wl_warning) then !wy2025-01-22
          call get_current_point(ipt,jpt,kpt,fpt)
